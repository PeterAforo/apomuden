// Apomuden Service Worker for Push Notifications and Offline Support

const CACHE_NAME = 'apomuden-v1';
...
self.addEventListener('sync', (event) => {
  ...
  if (event.tag === 'sync-emergency-request') {
    event.waitUntil(syncEmergencyRequests());
  }
});

async function syncEmergencyRequests() {
  // Get pending requests from IndexedDB and sync
