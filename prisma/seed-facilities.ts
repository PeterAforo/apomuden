// Run with: npx ts-node --compiler-options '{"module":"CommonJS"}' prisma/seed-facilities.ts
// Or: npx tsx prisma/seed-facilities.ts
...
const FACILITIES = [
  // Hospitals in Greater Accra
  {
    ...
    description: "Ghana's premier teaching hospital and the third largest hospital in Africa. Provides comprehensive healthcare services including specialized care.",
  },
  {
    ...
    icuBedsAvailable: 30,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "A military hospital that also serves civilians. Known for excellent trauma and emergency care.",
  },
  {
    name: "Ridge Hospital",
    slug: "ridge-hospital",
    ...
    icuBedsAvailable: 20,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "A major government hospital in the heart of Accra providing general and specialist healthcare services.",
  },
  {
    ...
    icuBedsAvailable: 15,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "The main government hospital serving Tema and surrounding communities with comprehensive healthcare services.",
  },
  {
    name: "Lekma Hospital",
    slug: "lekma-hospital",
    ...
    icuBedsAvailable: 10,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "A district hospital serving the Ledzokuku-Krowor Municipality with quality healthcare services.",
  },
  {
    ...
    icuBedsAvailable: 8,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "A leading private hospital offering world-class healthcare services with modern facilities.",
  },
  {
    name: "Trust Hospital",
  ...
  // Polyclinics
  {
    ...
    bedCount: 40,
    icuBedsAvailable: 0,
    operatingHours: { open: "08:00", close: "17:00", is24Hours: false },
    description: "A government polyclinic providing primary healthcare services to the Mamprobi community.",
  },
  {
    ...
    icuBedsAvailable: 0,
    operatingHours: { open: "08:00", close: "17:00", is24Hours: false },
    description: "A government polyclinic serving the Tema community with comprehensive primary healthcare.",
  },
  {
    ...
    icuBedsAvailable: 5,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "A major polyclinic serving the La community and surrounding areas.",
  },
  ...
  // Clinics in Tema
  {
    ...
    icuBedsAvailable: 0,
    operatingHours: { open: "08:00", close: "17:00", is24Hours: false },
    description: "A community clinic providing basic healthcare services to Community 5 residents.",
  },
  {
    ...
    bedCount: 15,
    icuBedsAvailable: 0,
    operatingHours: { open: "07:00", close: "20:00", is24Hours: false },
    description: "A private clinic offering quality healthcare services in Tema Community 11.",
  },
  {
    ...
    icuBedsAvailable: 2,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "The main government health facility serving the Ashaiman Municipality.",
  },
  ...
  // Health Centres
  {
    ...
    bedCount: 8,
    icuBedsAvailable: 0,
    operatingHours: { open: "08:00", close: "16:00", is24Hours: false },
  ...
  // Pharmacies
  {
    ...
    description: "A leading pharmacy chain providing quality medicines and health products.",
  },
  {
    name: "Kama Pharmacy",
  ...
  // Diagnostic Centres
  {
    ...
    bedCount: 0,
    icuBedsAvailable: 0,
    operatingHours: { open: "07:00", close: "18:00", is24Hours: false },
  ...
  },
  {
    ...
    bedCount: 0,
    icuBedsAvailable: 0,
    operatingHours: { open: "06:00", close: "20:00", is24Hours: false },
    description: "State-of-the-art diagnostic facility with advanced imaging and laboratory services.",
  },
  ...
  // Maternity Homes
  {
    ...
    icuBedsAvailable: 2,
    operatingHours: { open: "00:00", close: "23:59", is24Hours: true },
    description: "A specialized maternity facility providing antenatal, delivery, and postnatal care.",
  },
  {
    ...
    icuBedsAvailable: 0,
    operatingHours: { open: "08:00", close: "17:00", is24Hours: false },
    description: "Reproductive health clinic offering family planning and maternal health services.",
  },
];

async function seedFacilities() {
  console.log("🏥 Seeding Greater Accra and Tema facilities...\n");

  // Get or create Greater Accra region
  let greaterAccra = await prisma.region.findFirst({
    where: { name: "Greater Accra" },
  });

  if (!greaterAccra) {
    greaterAccra = await prisma.region.create({
      data: {
        name: "Greater Accra",
        code: "GA",
      },
    });
    console.log("✅ Created Greater Accra region");
  }
  ...
  for (const facility of FACILITIES) {
    ...
    if (!districtId) {
      console.log(`⚠️ District not found for ${facility.name}: ${facility.districtName}`);
      continue;
    }
